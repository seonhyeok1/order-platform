...
public enum OrderErrorStatus implements BaseCode {
	...
	INVALID_ORDER_STATUS_TRANSITION(HttpStatus.BAD_REQUEST, "ORDER005", "유효하지 않은 주문 상태 전이입니다."),
	ORDER_CANCEL_TIME_EXPIRED(HttpStatus.BAD_REQUEST, "ORDER006", "주문 취소 가능 시간이 초과되었습니다.");
