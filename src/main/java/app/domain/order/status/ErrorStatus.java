...
public enum ErrorStatus implements BaseCode {
	...
	ORDER_DIFFERENT_STORE(HttpStatus.BAD_REQUEST, "ORDER008", "서로 다른 매장의 메뉴는 함께 주문할 수 없습니다."),
	ORDER_ACCESS_DENIED(HttpStatus.FORBIDDEN, "ORDER009", "해당 주문에 대한 접근 권한이 없습니다."),
