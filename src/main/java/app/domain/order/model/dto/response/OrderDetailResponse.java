...
public class OrderDetailResponse {
	...
	public OrderDetailResponse(String storeName, List<Menu> menuList, Long totalPrice, String deliveryAddress, PaymentMethod paymentMethod, OrderChannel orderChannel, ReceiptMethod receiptMethod, OrderStatus orderStatus, String requestMessage) {
