...
import app.domain.auth.AuthController;
...
@Import({SecurityConfig.class, AuthControllerTest.TestConfig.class})    // securityConfig, TestConfig 명시적 선언
...
class AuthControllerTest {
	...
	class CreateUserTest {
		...
		void createUser_Success() throws Exception {
			...
			given(authService.createUser(any(CreateUserReq.class))).willReturn(expectedUserId);
		...
		void createUser_Fail_DuplicateUsername() throws Exception {
			...
			given(authService.createUser(any(CreateUserReq.class)))
