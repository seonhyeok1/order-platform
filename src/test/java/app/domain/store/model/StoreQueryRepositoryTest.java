...
class StoreQueryRepositoryTest {
	...
	void searchStoresWithAvgRating_success() {
		...
		// when
		PagedResponse<GetStoreListResponse> result = storeQueryRepository.searchStoresWithAvgRating("족발", StoreAcceptStatus.APPROVE, pageable);
	...
	void getAllStore_success() {
		...
		// when
		PagedResponse<GetStoreListResponse> result = storeQueryRepository.getAllStore(StoreAcceptStatus.APPROVE, pageable);
