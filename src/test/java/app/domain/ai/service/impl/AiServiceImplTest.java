...
class AiServiceImplTest {
	...
	void generateDescription() {
		...
		// Then
		assertNotNull(aiResponse.getRequestId());
		assertFalse(aiResponse.getGeneratedContent().isEmpty()); // 내용이 비어있지 않음을 확인
	}
	...
	void saveAiRequestToDatabase() {
		...
		AiHistory savedAiHistory = aiHistoryRepository.findById(java.util.UUID.fromString(aiResponse.getRequestId()))
			.orElse(null);
