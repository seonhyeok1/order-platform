...
class ReviewControllerTest {
	...
	void createReview_Success() throws Exception {
		...
		when(reviewService.createReview(1L, request)).thenReturn(successMessage);
	...
	// 	// given
	// 	CreateReviewRequest request = new CreateReviewRequest(1L, UUID.randomUUID(), 5L, "맛있어요");
	// 	when(reviewService.createReview(1L, any(CreateReviewRequest.class)))
	...
	// 	);
	// 	when(reviewService.createReview(1L, any(CreateReviewRequest.class))).thenReturn;
	//
	// 	// when & then
