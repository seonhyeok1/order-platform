...
class ManagerServiceImplTest {
	...
	private final ManagerService managerService = new ManagerService(userRepository);
	...
	void getAllUsersTest() {
		...
		// when
		PagedResponse<GetUserListResponse> response = managerService.getAllUsers(pageable);
